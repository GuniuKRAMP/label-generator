...
import TheLabel70x40 from "../components/Label70x40/TheLabel70x40.vue";
import Labels70x40ForPrinting from "../components/Label70x40/Labels70x40ForPrinting.vue";
...
<template>
  <div class="container">
    <div class="main" v-if="isVisible">
      <SubpageHeader> Etykiety 70x40mm </SubpageHeader>
