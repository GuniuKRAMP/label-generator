...
import TheLabel70x40 from '../components/TheLabel70x40.vue'
import SubpageHeader from '../components/SubpageHeader.vue'
import Labels70x40ForPrinting from '../components/Labels70x40ForPrinting.vue';
...
<template>
    <div class="main container" v-if="isVisible">
      <SubpageHeader>
        Etykiety 70x40mm
      </SubpageHeader>
    ...
    <div v-if="generatedLabales.length !== 0" class="result-section">
      ...
      <Labels70x40ForPrinting :labels="generatedLabales" :trashIconIsVisible="trashIconIsVisible" @remove-label="removeLabelById"/>
    </div>
