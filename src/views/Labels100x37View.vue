...
import TheLabel100x37 from '../components/TheLabel100x37.vue';
import Lables105x40ForPrinting from '../components/Lables105x40ForPrinting.vue';
import Labels100x37ForPrinting from '../components/Labels100x37ForPrinting.vue';
...
<template>
    ...
    <div v-if="generatedLabales.length !== 0" class="result-section">
      ...
      <Labels100x37ForPrinting :labels="generatedLabales" :trashIconIsVisible="trashIconIsVisible" @remove-label="removeLabelById"/>
    </div>
