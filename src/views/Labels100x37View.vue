...
import TheLabel100x37 from "../components/Label100x37/TheLabel100x37.vue";
import Labels100x37ForPrinting from "../components/Label100x37/Labels100x37ForPrinting.vue";
...
<template>
  <div class="container">
    <div class="main" v-if="isVisible">
      <SubpageHeader> Etykiety 100x37mm </SubpageHeader>
