...
import TheLabelPodest from "../components/Podest/TheLabelPodest.vue";
import SubpageHeader from "../components/SubpageHeader.vue";
import NoLabelsInfo from "../components/NoLabelsInfo.vue";
import PodestLabelsForPrinting from "../components/Podest/PodestLabelsForPrinting.vue";

const generatedLabales = ref([]);
const isVisible = ref(true);
const trashIconIsVisible = ref(false);
const labelsPerPage = ref(8);
...
<template>
  <div class="container">
    <div class="main" v-if="isVisible">
      <SubpageHeader> Etykiety Promocyjne (Podest) </SubpageHeader>
