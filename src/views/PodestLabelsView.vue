...
import TheLabelPodest from '../components/TheLabelPodest.vue'
import SubpageHeader from '../components/SubpageHeader.vue'
import NoLabelsInfo from '../components/NoLabelsInfo.vue';
import PodestLabelsForPrinting from '../components/PodestLabelsForPrinting.vue';
...
function addingLabelToArray() {
  if(generatedLabales.value.length < 8) {
...
<template>
    ...
    <div v-if="generatedLabales.length !== 0" class="result-section">
      ...
      <PodestLabelsForPrinting :labels="generatedLabales" :trashIconIsVisible="trashIconIsVisible" @remove-label="removeLabelById"/>
    </div>
